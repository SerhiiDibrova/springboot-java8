...
public interface SalesReportRepository extends JpaRepository<SalesReport, Long> {
    ...
    @Transactional
    @Modifying
    @Query(value = "CREATE TABLE #SalesReport AS SELECT * FROM [Order] AS o LEFT JOIN Sales_data AS s ON o.OrderId = s.OrderId", nativeQuery = true)
    ...
    <S extends SalesReport> S save(S entity);
