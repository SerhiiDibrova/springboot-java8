...
public class AuditController {
    ...
    public ResponseEntity<List<AuditDataDTO>> getAuditData(@PathVariable Integer managerId) {
        List<AuditDataDTO> auditData = auditService.insertAuditData(managerId);
    ...
    public ResponseEntity<List<AuditDataDTO>> retrieveAuditData(@RequestParam(required = false) Integer managerId) {
