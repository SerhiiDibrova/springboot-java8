...
public class WarehouseReportService {
    ...
    public void insertWarehouseReportData(String orderId, String regionName, String productCategory, String productId, int quantity, double price) {
        if (orderId == null || orderId.isEmpty() || regionName == null || regionName.isEmpty() ||
            productCategory == null || productCategory.isEmpty() || productId == null || productId.isEmpty()) {
        ...
        try {
            ...
            logger.error("Data access error while inserting warehouse report data: {}", e.getMessage());
        } catch (Exception e) {
            logger.error("Error inserting warehouse report data: {}", e.getMessage());
        }
    }
}